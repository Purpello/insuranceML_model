...
The winning model was a GBM (Gradient Boosting Machine model).  Below is a summary of metrics from 5 cross-validation rounds, followed by variable importances.
